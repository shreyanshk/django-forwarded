...
class Depth1(TestCase):
    ...
    def setUp(self):
        ...
        self.request._get_scheme = lambda: "http"

    def test_no_proxy(self):
        response = self.middleware(self.request)
        self.assertEqual(response.META['REMOTE_ADDR'], '127.0.0.1')
        self.assertEqual(response._get_scheme(), "http")
    ...
    def test_valid_ipv4(self):
        ...
        self.assertEqual(response._get_scheme(), "https")
    ...
    def test_multiple_proxies(self):
        self.request.META['HTTP_FORWARDED'] = ('for="[2001::1]";host=example.com;proto=https;proto-version="", '
                                               'for="[2001::2]";host=example.com;proto=http;proto-version="", '
...
class Depth2(TestCase):
    ...
    def test_multiple_proxies(self):
        self.request.META['HTTP_FORWARDED'] = ('for="[2001::1]";host=example.com;proto=https;proto-version="", '
                                               ...
                                               'for="[2001::3]";host=example.com;proto=http;proto-version=""')
        response = self.middleware(self.request)
...
class TrustedList(TestCase):
    ...
    def test_missing_by_parameter_in_chain(self):
        self.request.META['HTTP_FORWARDED'] = ('for=172.16.43.100;by="[2001::10:10]";host=example.com;proto=https;proto-version="", '
                                               'for="[2001::10:10]";host=example.com;proto=http;proto-version="", '
    ...
    def test_untrusted_origin(self):
        ...
        self.request.META['HTTP_FORWARDED'] = ('for="[2001::2]";by="[2001::1]";host=example.com;proto=https;proto-version="", '
                                               'for="[2001::123]";by=192.168.1.1;host=example.com;proto=http;proto-version="", ')
        response = self.middleware(self.request)
    ...
    def test_multiple_proxies(self):
        self.request.META['HTTP_FORWARDED'] = ('for=172.16.43.100;by="[2001::10:10]";host=example.com;proto=https;proto-version="", '
                                               'for="[2001::10:10]";by="[2001::1]";host=example.com;proto=http;proto-version="", '
                                               'for="[2001::1]";by=192.168.1.1;host=example.com;proto=http;proto-version=""')
        response = self.middleware(self.request)
    ...
    def test_multiple_fake_proxies(self):
        self.request.META['HTTP_FORWARDED'] = ('for=172.16.43.100;by="[2001::100:10]";host=example.com;proto=https;proto-version="", '
                                               'for="[2001::100:10]";by="[2001::100:11]";host=example.com;proto=http;proto-version="", '
                                               'for="[2001::100:11]";by="[2001::100:12]";host=example.com;proto=http;proto-version="", '
